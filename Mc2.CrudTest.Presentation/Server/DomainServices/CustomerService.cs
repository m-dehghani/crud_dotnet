...
namespace Mc2.CrudTest.Presentation.DomainServices
{
    public class CustomerService
    {
        ...
        public async Task CreateCustomerAsync(Customer customer)
        {
            ...
            var customerCreatedEvent = new CustomerCreatedEvent(customer.Id, customer.FirstName, customer.LastName, customer.PhoneNumber.Value, customer.Email.Value,customer.BankAccount.Value);
        ...
        {
            var customerUpdatedEvent = new CustomerUpdatedEvent(customer.Id, customer.FirstName, customer.LastName, customer.PhoneNumber.Value, customer.Email.Value,customer.BankAccount.Value);
